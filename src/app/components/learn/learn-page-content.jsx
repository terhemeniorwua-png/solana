...
import DevelopersResourceItem from "@/app/components/developers/DevelopersResourceItem";
import DevelopersDocumentItem from "@/app/components/developers/DevelopersDocumentItem";
import DevelopersHeroSection from "@/app/components/developers/DevelopersHeroSection";

export default function LearnPageContent({ tutorials, translations }) {
  const resources = [
    {
      href: "/docs",
